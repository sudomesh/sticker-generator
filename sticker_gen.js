...
module.exports = function(opts) {
    ...
    // Load fonts
    Canvas.registerFont(this.fontPath(this.opts.font.normal), {family: 'inconsolataNormal'})
    Canvas.registerFont(this.fontPath(this.opts.font.bold), {family: 'inconsolataBold'});
    ...
    this.writeLine = function(str, style, size, lineSpacing) {
        ...
        var fontStyles = {
            normal: (size || this.opts.font.size)+'px inconsolataNormal',
            bold: (size || this.opts.font.size)+'px inconsolataBold'
        }

        this.ctx.font = fontStyles[style];

        this.ctx.fillText(str, this.opts.padding.left, this.yOffset);
        this.yOffset += this.letterHeight + (lineSpacing || this.opts.font.lineSpacing);
        this.lineCount++;
    };
